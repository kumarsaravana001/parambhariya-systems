      ...
      <div className="w-full max-w-md">
        ...
        <Card padding="lg" className="flex flex-col gap-4">
          <form onSubmit={submit} className="flex flex-col gap-4">
            <FormField label="Email" htmlFor="email-index">
              <Input id="email-index" type="email" autoComplete="email"
                value={email} onChange={(e) => setEmail(e.target.value)}
                placeholder="you@farm.in" />
            </FormField>
            <FormField label="Password" htmlFor="password-index">
              <Input id="password-index" type="password" autoComplete="current-password"
...
export const Route = createFileRoute("/")({ component: IndexLoginScreen });
